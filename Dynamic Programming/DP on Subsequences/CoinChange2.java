/*
 * We are given an array Arr with N distinct coins and a target. We have an infinite supply of each 
 * coin denomination. We need to find the number of ways we sum up the coin values to give us the target.
...
public class CoinChange2 {
    ...
    // Tabulation Approach
    // Function to count the ways to make change
    static long countWaysToMakeChange1(int[] arr, int n, int T) {
        // Create a 2D array to store results of subproblems
        long dp[][] = new long[n][T + 1];
