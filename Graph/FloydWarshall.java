 ...
 *  of vertices in a given edge-weighted directed graph. The graph is represented as
 *  an adjacency matrix of size n*n. Matrix[i][j] denotes the weight of the edge from 
